# ScaviumP2P's Smart Contract

This is the official repository for all things regarding the ScaviumP2P smart contract.  
...
- [Contracts](#contracts)
  ...
  - [ScaviumP2P](#contract-scaviump2p)
    - [Variables](#scaviump2p-variables)
    - [Events](#scaviump2p-events)
    - [Modifiers](#scaviump2p-modifiers)
    - [Functions](#scaviump2p-functions)
...
4. Clone the repo: git clone https://github.com/e-scavo/scavium_p2p_exchange.git
...
* Set/verify creation parameter for ScaviumP2P contract in `./migrations/2_deploy_contracts_js`  
...
This is the main contract for the ScaviumP2P exchange.  
This contract uses the LSafeMath library for uint variables.  

#### `ScaviumP2P` Variables
...
#### `ScaviumP2P` Modifiers

#### `modifier isAdmin()`
This is a modifier for functions to check if the sending user address is the same as the admin user address.

#### `ScaviumP2P` Functions

#### `function ScaviumP2P(address admin_, address feeAccount_, uint feeTake_, uint freeUntilDate_, address predecessor_) public`
